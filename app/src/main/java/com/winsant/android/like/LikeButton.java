...
public class LikeButton extends FrameLayout implements View.OnClickListener {
    ...
    public void setLikeDrawableRes(@DrawableRes int resId) {
        ...
        if (iconSize != 0) {
            likeDrawable = CommonDataUtility.resizeDrawable(getContext(), likeDrawable, iconSize, iconSize);
        }
    ...
    public void setLikeDrawable(Drawable likeDrawable) {
        ...
        if (iconSize != 0) {
            this.likeDrawable = CommonDataUtility.resizeDrawable(getContext(), likeDrawable, iconSize, iconSize);
        }
    ...
    public void setUnlikeDrawableRes(@DrawableRes int resId) {
        ...
        if (iconSize != 0) {
            unLikeDrawable = CommonDataUtility.resizeDrawable(getContext(), unLikeDrawable, iconSize, iconSize);
        }
    ...
    public void setUnlikeDrawable(Drawable unLikeDrawable) {
        ...
        if (iconSize != 0) {
            this.unLikeDrawable = CommonDataUtility.resizeDrawable(getContext(), unLikeDrawable, iconSize, iconSize);
        }
    ...
    public void setIconSizeDp(int iconSize) {
        setIconSizePx((int) CommonDataUtility.dipToPixels(getContext(), (float) iconSize));
    }
    ...
    private Icon parseIconType(String iconType) {
        List<Icon> icons = CommonDataUtility.getIcons();
