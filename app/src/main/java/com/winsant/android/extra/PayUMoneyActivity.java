...
//        if (bundle != null) {
//
//            Double mAmount = Double.parseDouble(bundle.getString("amount"));
//
//            String mFirstName = bundle.getString("name");
//            String mEmailId = bundle.getString("email");
//            String mPhone = bundle.getString("mobile");
//
...
//      Required Fields
//     */
//            String mMerchantKey = "JzKklD85";
//            String mSalt = "rx8giwCnO5";
//            String mProductInfo = "winsant";
//            String mHash = hashCal("SHA-512", mMerchantKey + "|" +
//                    mTXNId + "|" +
//                    mAmount + "|" +
//                    mProductInfo + "|" +
//                    mFirstName + "|" +
...
//            String mAction = mBaseURL.concat("/_payment");
//
//            /**
//             * WebView Client
//             */
...
//            String mServiceProvider = "payu_paisa";
