...
public class FAQListAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,
        ...
        TextView lblListplus = (TextView) convertView
                .findViewById(R.id.lblplus);
        ...
        if (isExpanded) {
            ...
            lblListplus.setTextColor(Color.WHITE);
            lblListplus.setText("-");
        } else {
            convertView.setBackgroundResource(R.drawable.review_message);
            lblListHeader.setTextColor(Color.GRAY);
            lblListplus.setTextColor(Color.GRAY);
            lblListplus.setText("+");
        }
