package com.winsant.android.actionitembadge.library;
...
import com.winsant.android.actionitembadge.library.utils.BadgeDrawableBuilder;
import com.winsant.android.actionitembadge.library.utils.BadgeStyle;
import com.winsant.android.actionitembadge.library.utils.UIUtil;
...
//    }
    ...
    // TODO : HARDIK
    public static void Update(Activity activity, final MenuItem menu, int ico_menu_cart, BadgeStyle style, int badgeCount) {
        if (badgeCount == Integer.MIN_VALUE) {
            updateNew(activity, menu, ico_menu_cart, style, null, null);
        } else {
            updateNew(activity, menu, ico_menu_cart, style, String.valueOf(badgeCount), null);
        }
    }
...
//        if (style != null) {
//            UIUtil.setBackground(badgeView, new BadgeDrawableBuilder().corners(style.getCorner()).color(style.getColor())
//                    .colorPressed(style.getColorPressed()).strokeColor(style.getStrokeColor()).stroke(style.getStroke()).build(activity));
